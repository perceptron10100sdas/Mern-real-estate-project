...
export default function Search() {
  ...
  return (
    <div className='flex flex-col md:flex-row bg-gradient-to-r from-pink-300 to-white'>
      <div className='p-7  border-b-2 md:border-r-2 md:min-h-screen'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          <div className='flex items-center gap-2'>
            <label className='whitespace-nowrap font-thin'>Search Term:</label>
            <input
              type='text'
              id='searchTerm'
              placeholder='Search...'
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            ...
            <div className='flex gap-2'>
              ...
              <span className='font-thin'>Furnished</span>
            </div>
          </div>
          <div className='flex items-center gap-2'>
          ...
          <button className='bg-pink-700 text-white p-3 rounded-lg uppercase hover:opacity-95 font-light'>
            Search
          </button>
        </form>
      </div>
