...
export default function Creatlisting() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto bg-gradient-to-b from-pink-200 to-white'>
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
      ...
      <div className="flex flex-col flex-1 gap-4">
        ...
        <p className='text-red-700 text-sm'>
          ...
          <button disabled={loading || uploading} className='p-3 bg-red-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>
